...
const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    description: "First, you need to connect your wallet to interact with the Phreakin boxes. Click on the 'Connect Wallet' button in the header.",
  ...
  },
  {
    ...
    description: "Choose one of the available Phreakin boxes. Each box offers different rewards and experiences. Click on any available box to proceed.",
  ...
  },
  {
    id: "enter-amount",
    title: "Enter Amount",
    description: "Enter the amount you want to spend on the Phreakin Tools. You can choose different tokens and amounts based on your preference.",
