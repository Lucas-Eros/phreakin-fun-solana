...
export interface MysteryBoxActions {
  ...
  finishProcessing: (rewards?: RewardEvent[], usdcReceived?: number) => void;
    ...
    immer((set, get) => ({
      ...
      finishProcessing: (
        ...
        set((state) => {
          state.step = "finished";
          state.rewards = rewards;
          state.usdcReceived = usdcReceived || null;
...
export const selectMysteryBoxProcessing = (state: MysteryBoxStore) =>
  state.isProcessing;
export const selectMysteryBoxRewards = (state: MysteryBoxStore) =>
  state.rewards;
export const selectMysteryBoxTransactionHash = (state: MysteryBoxStore) =>
  state.transactionHash;
export const selectMysteryBoxSelectedBox = (state: MysteryBoxStore) =>
  state.selectedBox;
export const selectMysteryBoxUsdcReceived = (state: MysteryBoxStore) =>
  state.usdcReceived;
